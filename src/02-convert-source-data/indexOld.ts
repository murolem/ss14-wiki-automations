...
// if (fs.existsSync(stepDir.convertedData)) {
//     fs.emptyDirSync(stepDir.convertedData);
// } else {
//     fs.ensureDirSync(stepDir.convertedData)
// }

// // ======== generate jsons ========

// convertAndSaveInputData('recipes.lathes');
// convertAndSaveInputData('recipes.lathes.packs', PASSTHROUGH_YAML_SCHEMA);
...
//     const dataPathProjectInputAbsPath = path.resolve(path.join(stepDir.inputData, dataPath.projectInputPath));
...
//     // this path can be either to a file or a directory.
//     const dataPathProjectConvertedAbsPath = path.resolve(path.join(stepDir.convertedData, dataPath.projectConvertedPath));
